...
function GetFaqData(): ReadonlyArray<Question> {
	return [
		...
		},
		{
		  ...
		  "Answer": `We generate returns through a combination of rental income, property appreciation, and strategic sales. 
		  By carefully managing and improving the properties, we aim to maximize profits and return them to our investors.`,
		},
		{
		...
		},
		{
		  ...
		  "Answer": `Investors receive regular updates, including quarterly reports that detail property performance, financials, 
		...
		},
		{
		  ...
		  "Answer": `Investors typically receive distributions on a quarterly or annual basis, depending on the cash flow generated by 
